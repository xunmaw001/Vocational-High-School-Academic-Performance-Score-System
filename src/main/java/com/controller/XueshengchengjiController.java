        ...
        try {
            ...
            if(rows>1){
                ...
                for (int i = 1; i < rows; i++) {
                    ...
                    xueshengchengjiEntity.setKechengmingcheng(kechengmingcheng);
                    String keshi = CommonUtil.getCellValue(row.getCell(1));
                    xueshengchengjiEntity.setKeshi(keshi);
                    String xueqi = CommonUtil.getCellValue(row.getCell(2));
                    xueshengchengjiEntity.setXueqi(xueqi);
                    String nianxian = CommonUtil.getCellValue(row.getCell(3));
                    xueshengchengjiEntity.setNianxian(nianxian);
                    String chengji = CommonUtil.getCellValue(row.getCell(4));
                    xueshengchengjiEntity.setChengji(chengji);
                    String xuehao = CommonUtil.getCellValue(row.getCell(5));
                    xueshengchengjiEntity.setXuehao(xuehao);
                    String xueshengxingming = CommonUtil.getCellValue(row.getCell(6));
                    xueshengchengjiEntity.setXueshengxingming(xueshengxingming);
