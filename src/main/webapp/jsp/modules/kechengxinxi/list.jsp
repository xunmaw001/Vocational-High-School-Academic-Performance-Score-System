								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('nianxian')">年限<i id="nianxianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shangkeshijianCell  = document.createElement('td');
						  ...
						  if(item.shangkeshijian != null && item.shangkeshijian != "" && item.shangkeshijian.length >= 11){
			  	shangkeshijianCell.innerHTML = item.shangkeshijian.substring(0, 10) + "..."; 
			  }else{
			...
			var nianxianCell  = document.createElement('td');

						 nianxianCell.innerHTML = item.nianxian;

			row.appendChild(nianxianCell);
			...
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'xueshengxuanke','','[1]','已选课')");
