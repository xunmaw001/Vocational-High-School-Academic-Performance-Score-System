...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>课时</label>
										<input name="keshi" id="keshi" name="keshi" class="form-control" placeholder="课时">
									</div>
									<div class="form-group col-md-6">
										<label>上课时间</label>
										<textarea  name="shangkeshijian" class="form-control" id="shangkeshijian" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>上课地点</label>
									...
									<div class="form-group col-md-6">
										<label>年限</label>
										<input name="nianxian" id="nianxian" name="nianxian" class="form-control" placeholder="年限">
									</div>
									<div class="form-group col-md-6">
										<label>教师工号</label>
									...
									<div class="form-group col-md-6">
										...
										<input name="jiaoshixingming" id="jiaoshixingming" name="jiaoshixingming" class="form-control" placeholder="教师姓名">
											...
											<div class="form-group  col-md-12" >
												<label>课程详情</label>
												<div><div class="upload"><input id="kechengxiangqingupload" name="file" type="file">选择文件</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#nianxian").val(ruleForm.nianxian);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.nianxian != null && res.data.nianxian != ''){

						$("#nianxian").val(res.data.nianxian);
						$("#nianxian").attr('readonly','readonly');
					}
