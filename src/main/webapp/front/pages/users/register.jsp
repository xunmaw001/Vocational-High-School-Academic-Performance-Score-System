...
<html>
	...
	<body>
			...
			<form class="layui-form login-form" :style='{"padding":"20px","boxShadow":"none","borderColor":"rgba(43, 160, 232, 1)","backgroundColor":"rgba(255, 255, 255, 0.5)","borderRadius":"20px","borderWidth":"1px","width":"400px","borderStyle":"solid","justifyContent":"center","height":"auto"}'>
				...
				<div class="title" v-if="true" :style='{"padding":"0","boxShadow":"4px 4px 4px 4px #2BA0E8","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(43, 160, 232, 1)","isshow":true,"borderRadius":"100%","borderWidth":"0","width":"auto","lineHeight":"60px","fontSize":"20px","borderStyle":"solid"}'>管理员注册</p></div>
