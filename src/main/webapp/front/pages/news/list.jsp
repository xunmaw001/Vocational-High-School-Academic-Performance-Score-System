...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 标题 -->
			<div class="index-title" style="width: auto;" :style='{"padding":"10px 0 ","boxShadow":"none","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(78, 83, 86, 1)","borderRadius":"32px","alignItems":"center","borderWidth":"0","fontSize":"30px","borderStyle":"solid"}'>
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"none","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(110, 22, 64, 0)","borderRadius":"0","borderWidth":"0","background":"rgba(255, 255, 255, 0.3)","borderStyle":"solid"}'>
					...
					<div class="list">
						<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item" :class="3=='3'?'list-item3':3=='5'?'list-item5':''">
							<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
								<img :style='{"boxShadow":"none","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"80%","borderStyle":"solid","height":"200px"}' :src="baseurl+item.picture">
								<div class="info">
